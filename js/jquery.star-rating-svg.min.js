    ...
    var b = "starRating",
        ...
        f = {
            ...
            getIndex: function (b) {
                ...
                var g = c.index() - ("left" === e ? .1 : 0);
                return g = .1 > g && b.offsetX < d / 4 ? -1 : g, g = f && f <= this.settings.totalStars && f > g ? f - 1 : g
            },
            ...
            getSvgDimensions: function (a) {
                return "rounded" === a ? 'width="150px" height="150px" viewBox="0 146.8 550 500.2" style="enable-background:new 0 0 550 500.2;' : 'x="0px" y="0px" width="25px" height="25px" viewBox="60 -62 309 309" style="enable-background:new 64 -59 305 305;'
            },
